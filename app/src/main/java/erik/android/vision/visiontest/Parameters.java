...
public class Parameters {
    ...
    public static void initCameraParameters(Range<Integer> camSensitivityRange, Range<Long> camExposureTimeRange) {
        ...
        sensitivity = new NTBoundedNumber("Vision/sensitivity", camSensitivityRange.getLower(), camSensitivityRange.getUpper());
        exposureTime = new NTBoundedNumber("Vision/exposureTime", camExposureTimeRange.getLower(), camExposureTimeRange.getUpper());
    }
